...
<body>
    <div class="admin-container">
        ...
        <div class="recent-activity">
            ...
            <ul>
                <li>✅ Event "<?php echo $event['event_name']; ?>" was added</li>
                <li>📸 New gallery item "<?php echo $gallery['title']; ?>" uploaded</li>
                <li>📰 News article "<?php echo $news['news_title']; ?>" posted</li>
