...
<body>
    <div class="admin-container">
        ...
        <div class="recent-activity">
            ...
            <h4>🗓️ Events</h4>
            <ul>
                <?php if ($recent_event->num_rows > 0): ?>
            ...
            <ul>
                <?php if ($recent_gallery->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <li>No gallery uploads this week.</li>
                <?php endif; ?>
            </ul>
