                ...
                <?php foreach ($grouped as $date => $activities): ?>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <?php
                                    // Limit to displaying first 5 activities
                                    $count = 0;
                                    foreach ($activities as $activity) {
                                        if ($count < 5) {
                                            echo $activity['emoji'] . ' ' . $activity['type'] . ' "' . htmlspecialchars($activity['title']) . '" was added on ' . date("M d, Y", strtotime($activity['time'])) . '<br>';
                                            $count++;
                                        } else {
