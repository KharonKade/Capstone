...
// Collect news
$result_news = $conn_news->query("SELECT news_title AS title, created_at AS time FROM news_announcements WHERE status = 'active' AND publish_date BETWEEN '$start_date' AND '$end_date'");
