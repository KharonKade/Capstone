<?php
// Database connection
$conn = new mysqli("localhost", "root", "", "basf_news");  // Ensure you're connecting to the correct database for news
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    try {
        ...
        $conn->query("DELETE FROM news_announcements WHERE id = $news_id");
