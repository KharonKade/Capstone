                ...
                <table border="1">
                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='view_message.php?id={$id}' title='View'>
                                        <i class='fas fa-eye'></i>
                                    </a> |
                                    <a href='restore_inquiry.php?id={$id}' onclick='return confirm(\"Are you sure you want to restore this inquiry?\");' title='Restore'>
                                        <i class='fas fa-undo'></i>
                                    </a> |
                                    <a href='delete_inquiry.php?id={$id}' onclick='return confirm(\"Are you sure you want to delete this inquiry?\");' title='Delete'>
