                ...
                <table border="1">
                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <button onclick=\"toggleEditForm('editRow{$id}')\"><i class='fas fa-edit'></i></button>
                                    <button class='remove' onclick='deleteItem(\"handle_highlight_bmx.php?delete_id={$id}\")'><i class='fas fa-trash'></i></button>
                                </td>";
