                ...
                <table border="1">
                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='#' onclick=\"toggleEditForm('editRow{$row['id']}')\" class='edit-link'>
                                        <i class='fa fa-edit'></i> 
                                    </a>
                                    <a href='handle_highlight_bmx.php?delete_id={$row['id']}' class='remove-link' onclick='return confirm(\"Are you sure?\")'>
