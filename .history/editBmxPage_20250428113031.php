                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<td>
                                    <div style="display: flex; align-items: center; gap: 5px;">
                                        <a href="javascript:void(0);" onclick="toggleForm(\'editLeaderForm' . $row['id'] . '\')" style="height: 36px;" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a> |
                                        <form method="POST" action="handle_leaders_bmx.php" style="margin: 0;">
                                            <input type="hidden" name="id" value="' . $row['id'] . '">
                                            <a href="javascript:void(0);" onclick="this.closest(\'form\').submit();" style="height: 36px;" title="Remove">
                                                <i class="fa fa-trash"></i>
                                            </a>
                                        </form>
                                    </div>
