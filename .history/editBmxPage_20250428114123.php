                                ...
                                echo '<td>
                                    <div style="display: flex; align-items: center; gap: 5px;">
                                        ...
                                        <form method="POST" action="handle_leaders_bmx.php" style="margin: 0;">
                                            <input type="hidden" name="id" value="' . $row['id'] . '">
                                            <a href="javascript:void(0);" onclick="document.getElementById(\'remove-form-' . $row['id'] . '\').submit();" style="height: 36px;">
                                                <i class="fa fa-trash"></i> Remove
                                            </a>
                                            <!-- Hidden form to handle the delete action -->
                                            <form id="remove-form-' . $row['id'] . '" method="POST" action="handle_leaders_bmx.php" style="display:none;">
                                                <input type="hidden" name="id" value="' . $row['id'] . '">
