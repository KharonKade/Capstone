    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <section>
                ...
                <button onclick="showEditForm('aboutUsForm')">
                ...
                <form id="aboutUsForm" style="display:none;" method="post" action="handle_aboutus.php">
                    ...
                    <button type="button" onclick="hideForm('aboutUsForm')">
            ...
            <section>
                ...
                <form id="addHighlightForm" style="display:none;" method="post" action="handle_highlight_bmx.php" enctype="multipart/form-data">
                    ...
                    <button type="button" onclick="hideForm('addHighlightForm')">
                        <i class="fa fa-times"></i> Cancel
                    </button>
                </form>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td colspan='4'>
                                    <form method='post' action='handle_highlight_bmx.php' enctype='multipart/form-data' style='display:flex; flex-direction:culomn; gap:5px; padding: 10px;'>
                                        ...
                                        <button type='button' onclick=\"toggleEditForm('editRow{$row['id']}')\">
                                            <i class='fa fa-times'></i> Cancel
                                        </button>
                                    </form>
                                </td>";
            ...
            <section>
                ...
                <form id="addAthleteForm" style="display:none;" method="post" action="handle_athletes_bmx.php" enctype="multipart/form-data">
                    ...
                    <button type="button" onclick="hideForm('addAthleteForm')">
                        <i class="fa fa-times"></i> Cancel
                    </button>
                    </div>
                </form>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<button onclick=\"showEditForm('editAthleteForm{$row['id']}')\">
                            <i class='fa fa-edit'></i> Edit
                        </button>";
                    echo "<button class='remove' onclick=\"confirmDelete({$row['id']})\">
                    ...
                    echo "<button type='button' onclick=\"hideForm('editAthleteForm{$row['id']}')\">
                            <i class='fa fa-times'></i> Cancel
                        </button>";
                    echo "</div>";
                    echo "</form></div>";
            ...
            <section>
                ...
                <form id="addLeaderForm" style="display: none;" method="POST" action="handle_leaders_bmx.php" enctype="multipart/form-data">
                    ...
                    <button type="button" onclick="hideForm('addLeaderForm')">
                        <i class="fa fa-times"></i> Cancel
                    </button>
                </form>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<td>
                                    ...
                                    <form id="editLeaderForm' . $row['id'] . '" style="display: none; margin-top: 10px;" method="POST" action="handle_leaders_bmx.php" enctype="multipart/form-data">
                                        ...
                                        <a href="javascript:void(0);" onclick="document.getElementById(\'editLeaderForm' . $row['id'] . '\').submit();" style="display: inline-block; padding: 10px; background-color: #4CAF50; color: white; border-radius: 5px;">
                                            <i class="fa fa-check"></i> Update
                                        </a>

                                        <!-- Cancel button with icon -->
                                        <a href="javascript:void(0);" onclick="toggleForm(\'editLeaderForm' . $row['id'] . '\');" style="display: inline-block; padding: 10px; background-color: #f44336; color: white; border-radius: 5px;">
                                            <i class="fa fa-times"></i> Cancel
                                        </a>
                                    </form>
                                </td>';
