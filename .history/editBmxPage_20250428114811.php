                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<td>
                                    ...
                                    <form id="editLeaderForm' . $row['id'] . '" style="display: none; margin-top: 10px;" method="POST" action="handle_leaders_bmx.php" enctype="multipart/form-data">
                                        ...
                                        <a href="javascript:void(0);" onclick="document.getElementById(\'editLeaderForm' . $row['id'] . '\').submit();" >
                                            <i class="fa fa-check"></i> Update
                                        </a>

                                        <!-- Cancel button with icon -->
                                        <a href="javascript:void(0);" onclick="toggleForm(\'editLeaderForm' . $row['id'] . '\');" >
                                            <i class="fa fa-times"></i> Cancel
                                        </a>
                                    </form>
                                </td>';
