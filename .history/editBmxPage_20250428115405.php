                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<td>
                                        <form method="POST" action="handle_partnerships_bmx.php" style="margin: 0;">
                                            ...
                                            <a href="javascript:void(0);" onclick="this.closest(\'form\').querySelector(\'button[type=submit]\').click();" style="display: inline-block; padding: 10px; background-color: #f44336; color: white; border-radius: 5px; text-decoration: none;">
                                                <i class="fa fa-trash"></i> Remove
                                            </a>
                                        </form>
                                    </td>';
