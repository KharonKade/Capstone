            ...
            <section>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    while ($ach = $achievements->fetch_assoc()) {
                        ...
                        echo "<button class='remove' type='button' onclick=\"removeAchievement('achievement-{$ach['id']}')\" style='display: inline-block; padding: 10px; background-color: #f44336; color: white; border-radius: 5px;'>
                    ...
                    while ($img = $gallery->fetch_assoc()) {
                        ...
                        echo "<button class='remove' type='button' onclick=\"removeGalleryImage('gallery-{$img['id']}', '{$row['id']}')\" style='display: inline-block; padding: 10px; background-color: #f44336; color: white; border-radius: 5px;'>
                                <i class='fa fa-trash'></i> Remove
                            </button>";
                        echo "</div>";
