    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            function addNewGalleryImage() {
                ...
                newForm.classList.add('form'); // Add the 'form' class to the form element

                // Create the gallery item container
                const newGalleryItem = document.createElement('div');
                newGalleryItem.classList.add('gallery-item');

                // Add the input and textarea inside the form
                ...
                // Append the gallery item to the form
                newForm.appendChild(newGalleryItem);
