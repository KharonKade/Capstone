...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_FILES['athlete_image']['name'])) {
        ...
        $athlete_bio = $_POST['athlete_bio'];
        $athlete_wins = $_POST['athlete_wins'];
        $athlete_podium = $_POST['athlete_podium'];
        $athlete_years_active = $_POST['athlete_years_active'];
        $athlete_specialty = $_POST['athlete_specialty'];
        ...
        $stmt->execute();
        $athlete_id = $stmt->insert_id; // Get the newly inserted athlete's ID
        $stmt->close();
    
        // Insert achievements into achievements table
        if (!empty($_POST['achievement_title']) && !empty($_POST['achievement_desc'])) {
            ...
            foreach ($_POST['achievement_title'] as $index => $title) {
                $description = $_POST['achievement_desc'][$index];
