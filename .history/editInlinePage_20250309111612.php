        ...
        <main class="content">
            ...
            <section>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<button onclick=\"deleteItem('handle_highlight.php?id={$row['id']}')\">Delete</button>";
            ...
            <section>
                ...
                <form id="addAthleteForm" style="display:none;" method="post" action="handle_athlete.php" enctype="multipart/form-data">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<button onclick=\"deleteItem('handle_athlete.php?id={$row['id']}')\">Delete</button>";
