        ...
        <main class="content">
            ...
            <section>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Editable fields
                    echo "<input type='text' id='title-{$row['id']}' value='{$row['title']}' onchange='updateHighlight({$row['id']})'>";
                    echo "<textarea id='desc-{$row['id']}' onchange='updateHighlight({$row['id']})'>{$row['description']}</textarea>";

                    // File Upload (Only when needed)
                    echo "<input type='file' id='video-{$row['id']}' onchange='updateHighlight({$row['id']}, true)'>";
