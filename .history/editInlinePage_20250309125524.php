    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <section>
                ...
                <form id="addHighlightForm" style="display:none;" enctype="multipart/form-data" onsubmit="addHighlight(event)">
                ...
                <div id="highlightContainer">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<form id='editHighlightForm{$row['id']}' style='display:none;' enctype='multipart/form-data' onsubmit='updateHighlight(event, {$row['id']})'>";
