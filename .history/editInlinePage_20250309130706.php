    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <section>
                ...
                <!-- Add Highlight Form -->
                <form id="addHighlightForm" style="display:none;" action="handle_highlight.php" method="POST" enctype="multipart/form-data">
                ...
                <div id="highlightContainer">
                    <?php
                    $result = $conn->query("SELECT id, video, title, description FROM highlight_carousel");
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<button onclick='deleteHighlight({$row['id']})'>Delete</button>";

                        // Edit Highlight Form
                        echo "<form id='editHighlightForm{$row['id']}' style='display:none;' action='handle_highlight.php' method='POST' enctype='multipart/form-data'>";
            ...
            function updateHighlight(event, id) {
                event.preventDefault(); 

                let form = document.getElementById(`editHighlightForm${id}`);
                let formData = new FormData(form);

                fetch("handle_highlight.php", {
                    method: "POST",
                    body: formData
                })
                ...
                .then(data => {
                    ...
                    location.reload(); // Refresh the page to reflect the updated content
                })
