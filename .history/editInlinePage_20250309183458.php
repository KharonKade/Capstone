        ...
        <main class="content">
            ...
            <section>
                ...
                <form id="addAthleteForm" style="display:none;" method="post" action="handle_athletes.php" enctype="multipart/form-data">
                    ...
                    <textarea name="description" placeholder="Short Bio" required></textarea>
                    ...
                    <textarea name="achievements" placeholder="Achievements (Separate with commas)" required></textarea>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    foreach ($galleryImages as $image) {
                        echo "<img src='{$image}' alt='Athlete Image'>";
                    }
                    echo "</div>";
                    ...
                    echo "<textarea name='achievements' required>{$row['achievements']}</textarea>";
                    echo "<input type='file' name='image'>";
                    echo "<input type='file' name='gallery[]' multiple>";
                    echo "<button type='submit'>Update</button>";
                    echo "</form>";
