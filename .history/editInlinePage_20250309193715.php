    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <section>
                ...
                <?php
                  // Fetch all top athletes
                $query = "SELECT * FROM top_athletes";
                $result = $conn_content->query($query);
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Fetch achievements from the separate table
                    ...
                    // Fetch athlete's gallery images
