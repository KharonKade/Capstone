    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            document.addEventListener("DOMContentLoaded", function () {
                // Toggle Achievements Form
                document.addEventListener("click", function (e) {
                    if (e.target.classList.contains("add-achievement")) {
                        let athleteId = e.target.getAttribute("data-athlete");
                        let form = document.getElementById("newAchievementForm" + athleteId);
                ...
                // Toggle Gallery Form
                document.addEventListener("click", function (e) {
                    if (e.target.classList.contains("add-gallery")) {
                        let athleteId = e.target.getAttribute("data-athlete");
                        let form = document.getElementById("newGalleryForm" + athleteId);
                        form.style.display = form.style.display === "none" ? "block" : "none";
                    }
                });
            });
            ...
            function addAchievement(athleteId) {
                let title = document.getElementById("newTitle" + athleteId).value.trim();
                let description = document.getElementById("newDescription" + athleteId).value.trim();
            ...
            function addGalleryImage(athleteId) {
                ...
                let description = document.getElementById("newImageDescription" + athleteId).value.trim();
