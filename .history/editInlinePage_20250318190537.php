            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($gallery->num_rows > 0) {
                    while ($img = $gallery->fetch_assoc()) {
                        ...
                        echo "<img src='{$img['image']}' alt='Athlete Image' width='50'><br>";
                ...
                echo "<form method='post' action='delete_athlete.php' style='display:inline;'>";
                echo "<input type='hidden' name='delete_id' value='{$row['id']}'>";
                echo "<button type='submit' onclick='return confirm(\"Are you sure you want to delete this athlete?\")'>Delete</button>";
                echo "</form>";
                echo "</td>";
