                ...
                <table border="1">
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                        <strong>Wins:</strong> {$row['wins']}<br>
                                        <strong>Podium Finishes:</strong> {$row['podium_finishes']}<br>
                                        <strong>Years Active:</strong> {$row['years_active']}<br>
                                        <strong>Specialty:</strong> {$row['specialty']}
                                    </td>";
                                    ...
                                    while ($img = $gallery->fetch_assoc()) {
                                        echo "<img src='{$img['image']}' alt='Gallery Image' width='50' style='margin:5px;'>";
                                    }
                                    echo "</td>";

                                    // Edit Button
                                    echo "<td><button onclick=\"openEditModal({$row['id']})\">Edit</button></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
