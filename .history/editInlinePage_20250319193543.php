                ...
                <table border="1">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            // Edit Modal
                            echo "<div id='editAthleteModal{$row['id']}' class='modal'>";
                            echo "<div class='modal-content'>";
                            echo "<span class='close' onclick=\"hideModal('editAthleteModal{$row['id']}')\">&times;</span>";
...
function addAchievement(containerId) {
    ...
    let newAchievement = document.createElement("tr"); // Use <tr> for table row
    newAchievement.classList.add("achievement");
    newAchievement.innerHTML = `
        <td><input type="hidden" name="achievement_ids[]" value="new"></td>
        <td><input type="text" name="achievements[]" placeholder="Title" required></td>
        <td><textarea name="achievements_descriptions[]" placeholder="Description" required></textarea></td>
        <td><button type="button" onclick="removeAchievement(this)">Remove</button></td>
    `;
    container.appendChild(newAchievement);
}
...
function addGalleryImage(containerId) {
    ...
    let newImageRow = document.createElement("tr"); // Use <tr> for table row
    newImageRow.classList.add("gallery-item");
    newImageRow.innerHTML = `
        <td><input type="hidden" name="gallery_existing_ids[]" value="new"></td>
        <td><input type="file" name="athlete_gallery[]" accept="image/*" required></td>
        <td><textarea name="gallery_descriptions[]" placeholder="Image Description" required></textarea></td>
        <td><button type="button" onclick="removeGalleryImage(this)">Remove</button></td>
    `;
