    ...
    <div class="admin-container">
        ...
        <main class="content">
                ...
                <table border="1">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            // Hidden Edit Form (Inside a new row)
                        ...
                        echo "<div>";
                        while ($img = $gallery->fetch_assoc()) {
                            echo "<img src='{$img['image']}' width='50'>";
                        ...
                        echo "<button type='button' onclick=\"toggleEditForm('editAthleteForm{$row['id']}')\">Cancel</button>";
                        echo "</form>";
                        echo "</td></tr>";
            ...
            function toggleEditForm(formId) {
                // Hide all open edit forms
                document.querySelectorAll("tr[id^='editAthleteForm']").forEach(form => {
                    if (form.id !== formId) {
                        form.style.display = "none";
                    }
                });
