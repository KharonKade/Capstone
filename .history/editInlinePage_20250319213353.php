    ...
    <div class="admin-container">
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<strong>Wins:</strong> {$row['wins']}<br>";
                echo "<strong>Podium Finishes:</strong> {$row['podium_finishes']}<br>";
                echo "<strong>Years Active:</strong> {$row['years_active']}<br>";
                echo "<strong>Specialty:</strong> {$row['specialty']}";
                echo "</td>";
                ...
                echo "<form id='editAthleteForm{$row['id']}' class='hidden' style = 'hidden' method='post' action='handle_athletes.php' enctype='multipart/form-data'>";
                ...
                echo "</div>";
                echo "<button type='button' onclick=\"addAchievement('achievements-container-{$row['id']}')\">+ Add More</button>";
                ...
                echo "</div>";
                echo "<button type='button' onclick=\"addGalleryImage('gallery-container-{$row['id']}')\">+ Add More</button>";
