                ...
                <?php
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        while ($ach = $achievements->fetch_assoc()) {
                            echo "<strong>{$ach['title']}</strong>: {$ach['description']}<br>";
                        }
                        echo "</td>";
                        ...
                        while ($img = $gallery->fetch_assoc()) {
                            echo basename($img['image']) . " - {$img['description']}<br>";
                        }
                        echo "</td>";
                        ...
                        echo "<td>
                                ...
                                <form method='post' action='handle_athletes.php' style='display:inline;'>
                        ...
                        echo "<tr id='editAthleteForm{$row['id']}' style='display:none;'><td colspan='11'>";
