            ...
            <section>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    while ($ach = $achievements->fetch_assoc()) {
                        ...
                        echo "<button type='button' onclick=\"removeElement('achievement-{$ach['id']}')\">Remove</button>";
                        echo "</div>";
                    }
                    echo "</div>";
                    ...
                    while ($img = $gallery->fetch_assoc()) {
                        echo "<div class='edit-gallery-item'>";
                        ...
                        echo "<button type='button' onclick=\"removeElement('gallery-{$img['id']}')\">Remove</button>";
                        echo "</div>";
