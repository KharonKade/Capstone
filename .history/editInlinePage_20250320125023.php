                ...
                <table border="1">
                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <button onclick=\"toggleEditForm('editHighlightForm{$row['id']}')\">Edit</button>
                                    <button class='remove' onclick='deleteItem(\"handle_highlight.php?delete_id={$row['id']}\")'>Remove</button>
                                </td>";
                            
                            // Edit form inside the same row
                            echo "<td colspan='4' style='display:none; padding:10px; background:#f9f9f9;' id='editHighlightForm{$row['id']}'>
                                    <form method='post' action='handle_highlight.php' enctype='multipart/form-data' style='display:flex; flex-direction:column; gap:5px;'>
                                        ...
                                        <button type='submit'>Update</button>
                                        <button type='button' onclick=\"toggleEditForm('editHighlightForm{$row['id']}')\">Cancel</button>
                                    </form>
                                </td>";
                            echo "</tr>";
                        }
