                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td colspan='4' style='padding: 10px;'>
                                    <form method='post' action='handle_highlight.php' enctype='multipart/form-data' style='display:flex; flex-direction:column; gap:5px; padding:10px; width:100%;'>
