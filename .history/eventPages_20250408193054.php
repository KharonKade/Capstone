...
document.getElementById('manageRegistrationLink').addEventListener('click', function() {
...
function manageRegistration() {
    ...
    // Redirect to token validation page (edit or delete registration)
    window.location.href = 'manage_registration.php?token=' + token;
}
