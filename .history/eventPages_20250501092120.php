    ...
    <div id="tokenModal" class="registration-modal" style="display:none;" onclick="closeTokenModal(event)">
        <div class="modal-content" onclick="event.stopPropagation();">
            ...
            <form id="tokenForm" action="manage_registration.php" method="POST">
                ...
                <button type="submit">Submit</button>
                <a href="forgot_token.php" id="forgotTokenLink">Forgot your token?</a>
            </form>
        </div>
    </div>

    <!-- Forgot Token Success Modal -->
    <div id="tokenSuccessModal" style="display:none;">
        <div class="modal-content">
            <span class="close" onclick="closeTokenSuccessModal()">&times;</span>
            <h2>Your Token</h2>
            <p>Your token is: <span id="retrievedToken" style="font-weight: bold;"></span></p>
            <button onclick="closeTokenSuccessModal()">Close</button>
        </div>
    </div>
