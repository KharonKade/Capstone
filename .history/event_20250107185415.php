                            ...
                            <div class="flip-card">
                                <div class="flip-card-inner">
                                    ...
                                    <div class="flip-card-front">
                                        <img src="<?= $row['image_path'] ?>" alt="<?= htmlspecialchars($row['event_name']) ?>">
                                    </div>
                                    ...
                                    <div class="flip-card-back" style="background-image: url('<?= $row['image_path'] ?>');">
                                        ...
                                        <div class="back-content">
                                            <p class="event-name"><?= htmlspecialchars($row['event_name']) ?></p>
                                            <p class="event-details">Category: <?= htmlspecialchars($row['category']) ?></p>
                                            <p class="event-details">Date: <?= htmlspecialchars($row['event_date']) ?></p>
                                            <br>
