                            ...
                            <div class="flip-card">
                                <div class="flip-card-inner">
                                    ...
                                    <div class="flip-card-front">
                                        <img src="<?php echo $row['image_path']; ?>" alt="<?php echo htmlspecialchars($row['event_name']); ?>">
                                    </div>
                                    <!-- Back Side (Blurred Background with Event Details) -->
                                    <div class="flip-card-back" style="background-image: url('<?php echo $row['image_path']; ?>');">
                                        <div class="overlay"></div>
                                        <div class="back-content">
                                            <p class="event-name"><?php echo htmlspecialchars($row['event_name']); ?></p>
                                            <p class="event-details">Category: <?php echo htmlspecialchars($row['category']); ?></p>
                                            <p class="event-details">Date: <?php echo htmlspecialchars($row['event_date']); ?></p>
                                            <br>
                                            <p class="event-details">Click for more...</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
