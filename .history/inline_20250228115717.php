...
<body>
    ...
    function updateSlides() {
        slides.forEach((slide, index) => {
            if (index === currentIndex) {
                ...
                slide.style.left = "calc(50% + 240px)";
                slide.style.opacity = "1";
            } else if (index === currentIndex + 2) {
                slide.style.left = "calc(50% + 500px)";
                slide.style.opacity = "1";
            } else if (index === currentIndex + 3) {
                slide.style.left = "calc(50% + 760px)";
                slide.style.opacity = "1";
            } else if (index === currentIndex + 4) {
                slide.style.left = "calc(50% + 1020px)";
    ...
    // Click event for slides in queue
    slides.forEach((slide, index) => {
