                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '<div class="carousel-item">
                                <video src="' . htmlspecialchars($row["video"]) . '" autoplay muted loop 
                                    onclick="openModal(this, ' . $row["id"] . ', `' . htmlspecialchars($row["title"], ENT_QUOTES) . '`, `' . htmlspecialchars($row["description"], ENT_QUOTES) . '`)">
                                </video>
                            </div>';
                    }
                } else {
