...
<body>
            ...
            <div class="carousel">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<!-- DEBUG: Video=$video, Title=$title, Description=$description -->";
                    }
                } else {
    ...
    <script>
        ...
        function openModal(videoElement, id, title, description) {
            ...
            console.log("Before Fix - Title:", title);
            console.log("Before Fix - Description:", description);
            
            // Temporarily set values manually
            title = "Test Event";
            description = "This is a test description.";

            console.log("After Fix - Title:", title);
            console.log("After Fix - Description:", description);
