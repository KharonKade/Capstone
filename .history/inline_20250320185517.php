...
<body>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<div class="carousel-item">
                                    <video src="' . $video . '" autoplay muted loop 
                                        onclick="openModal(this, ' . $row["id"] . ', \'' . addslashes($row["title"]) . '\', \'' . addslashes($row["description"]) . '\')">
                                    </video>
                                </div>';
    ...
    <script>
        ...
        function openModal(videoElement, id, title, description) {
            ...
            console.log("ID:", id);
            console.log("Title (Before Fix):", title);
            console.log("Description (Before Fix):", description);

            if (!title || title === "undefined") {
                title = "Default Title";  // Replace with a default title if missing
            }
            if (!description || description === "undefined") {
                description = "Default Description";  // Replace with a default description
            }

            console.log("Title (After Fix):", title);
            console.log("Description (After Fix):", description);

            document.getElementById("videoTitle").textContent = title;
            document.getElementById("videoDescription").textContent = description;

            document.getElementById("videoModal").style.display = "block";
            document.getElementById("modalVideo").src = videoElement.src;
        }
