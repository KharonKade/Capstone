...
<body>
    ...
    <div class="news-page animate-on-scroll">
        ...
        <div class="right-section animate-on-scroll">
            ...
            <h2 class="news-title"><?php echo isset($news['title']) ? $news['title'] : 'Untitled News'; ?></h2>
            <p class="news-meta">
                <span class="category"><?php echo isset($news['category']) ? $news['category'] : 'General'; ?></span> |
                <span class="date"><?php echo isset($formatted_publish_date) ? $formatted_publish_date : 'Not available'; ?></span>
            </p>
            <div class="news-content">
                <?php echo isset($news['news_content']) ? nl2br($news['news_content']) : 'Not available'; ?>
            </div>
            </div>
        </div>
        </div>

        <button onclick="history.back()" class="return-btn animate-on-scroll">← Return to News List</button>
