...
<head>
    ...
    <title>Skateboarding Page</title>
...
<body>
    ...
    <section class="skateboard-content">
    ...
    <section class="container skateboard-container" id="events">
        <h2>Events & Activities</h2>
        <!-- News Carousel -->
        <div class="skateboard-carousel" id="eventCarousel">
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-front">
                                <img src="images/sumvac.png" alt="News 1">
                            </div>
                            <!-- Back Side (black background with details) -->
                            <div class="flip-card-back">
                                <div class="back-content">
                                    <p>SumVac 2024 "Quench 1"</p>
            ...
            <!-- Repeat news items below (You can loop or dynamically generate these) -->
            <div class="skateboard-item">
                <a href="your-link-here.html">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <!-- Front Side (image) -->
                            <div class="flip-card-front">
                                <img src="images/adreall.png" alt="News 2">
                            </div>
                            <!-- Back Side (black background with details) -->
                            <div class="flip-card-back">
                                <div class="back-content">
                                    <p>August Adrenaline Alley</p>
                                    <p>Competition Event</p>
                                    <p>August 23, 2024</p>
                                    <br>
                                    <p>click for more....</p>
            ...
            <!-- More News Items (same structure as above) -->
        </div>
