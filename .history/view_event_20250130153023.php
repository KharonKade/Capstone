        ...
        <ul>
            <?php if ($registrations->num_rows > 0): ?>
                <?php while ($registration = $registrations->fetch_assoc()): ?>
                    <li>
                        <strong>Name:</strong> <?php echo htmlspecialchars($registration['user_name']); ?> | 
                        <strong>Email:</strong> <?php echo htmlspecialchars($registration['user_number']); ?> | 
                        <strong>Registration Number:</strong> <?php echo htmlspecialchars($registration['registration_number']); ?>
                    </li>
                <?php endwhile; ?>
            <?php else: ?>
