...
<body>
    ...
    <img src="images/uploads/<?php echo htmlspecialchars($gallery['thumbnail']); ?>" alt="Thumbnail" class="view-thumbnail">
    ...
    <div class="gallery-container">
        <?php while ($image = mysqli_fetch_assoc($images_result)) { ?>
            <img src="images/uploads/<?php echo htmlspecialchars($image['image_path']); ?>" alt="Gallery Image">
        <?php } ?>
    </div>
