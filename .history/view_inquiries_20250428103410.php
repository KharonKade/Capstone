                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    if ($row["archived"] == 0) {
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <a href='view_message.php?id=<?php echo $row["id"]; ?>' title="View">
                                        <i class="fas fa-eye"></i>
                                    </a> |
                                    <a href='archive_inquiry.php?id=<?php echo $row["id"]; ?>' onclick='return confirm("Are you sure you want to archive this inquiry?");' title="Archive">
                                        <i class="fas fa-box-archive"></i>
                                    </a> |
                                    <a href='delete_inquiry.php?id=<?php echo $row["id"]; ?>' onclick='return confirm("Are you sure you want to delete this inquiry?");' title="Delete">
